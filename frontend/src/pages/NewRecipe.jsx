...
function NewRecipe () {
  ...
  // handle mealtype changing
  const handleChangeMealtype = (newMealtype) => {
    setMealType(newMealtype);
  }

  // handle method, ingredients, proportion entered
  ...
  // handle IMG upload and chage the img data into base64 format
  ...
  // add one more line of ingredients or method when user clicking the + button on the page
  ...
  // delete one line of ingredients or method when user clicking the delete button on the page
  ...
  // check if all the required information are in good format
  ...
  // check if all the required listed information are in good format
  ...
  // handle the process when user click the submit new recipe button
  const handleSubmit = () => {
    ...
    // console.log(ppts);
    // console.log(methods);
    // console.log(checkValid(src));
    // console.log(checkValid(mealtype, 'mealtype'));
      ...
      fetch(url, {
        ...
        if (rs.status === 200) {
          rs.json().then(result => {
            ...
            setOpen(true);
            setSeverity('success');
            setAlertMsg('We have add your recipe!');
          ...
          <Grid item xs={12} sm={12}>
            ...
            {igdKeys.map((igd) => (
              <div key={igd} className={classes.root}>
                ...
                placeholder={`add ingredients${igd}`}
                ...
                placeholder={`ingredients proportion${igd}`}
